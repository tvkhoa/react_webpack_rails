...
if defined?(Rails)
  ...
  require 'react_webpack_rails/storage'
  require 'react_webpack_rails/storage/integrations/react'
  require 'react_webpack_rails/storage/integrations/react_router'
